...
class AnilistDiscord:
  ...
  def get_manga_info(self, manga_name):
    manga_dict = anilist.get_manga(manga_name)
    return manga_dict
  ...
  def get_anime_discord(self, anime_name):
    ...
    key_list = [
      eng_name, jap_name, desc, starting_time, ending_time, cover_image,
      airing_format, airing_status, airing_ep, season, genres_new,
      next_ep_string
    ]
    ...
    #   text='Supported by the AnilistPython Library (ReZeroK)')
